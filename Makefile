...
OBJ_DIR = obj/
SRC		= main.c get_args.c clean_args.c path.c first_pars.c libft/ft_split.c libft/ft_strjoin.c \
			extension.c libft/ft_strchr.c libft/ft_strlen.c libft/ft_isalpha.c quotes.c spaces.c \
			libft/ft_strdup.c fin_token.c libft/ft_calloc.c libft/ft_strjoin_slash.c libft/ft_bzero.c \
			libft/ft_itoa.c libft/ft_strncmp.c libft/ft_split_or.c echo/echo.c cd/cd.c env/env.c \
