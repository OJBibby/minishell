...
OBJ_DIR = obj/
SRC		= main.c get_args.c clean_args.c path.c libft/ft_split.c libft/ft_strjoin.c libft/ft_strchr.c \
			...
			libft/ft_itoa.c libft/ft_strncmp.c echo/echo.c cd/cd.c env/env.c env/utils.c exit/exit.c \
			pwd/pwd.c execute/execute.c execute/init.c execute/io.c execute/output.c \
